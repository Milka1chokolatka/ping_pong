...
bg = transform.scale(image.load('bg.jpg'), (W, H))# трансформуємо картинку в розміри вікна
...
player1 = Player('der.png', 5, 5, 50, 130, 10, 10)
player2 = Player('poli.png', 750, 250, 50, 130, 10, 10)
ball = Ball('DEBIL.png', W / 2, H / 2, 70, 70, 5, 5)
