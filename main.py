...
bg = transform.scale(image.load('bg.jpg'),(W,H))#транформуємо картину в розмірі вікна
...
class Player(GameSprite):#клас для гравців
    ...
    def update_l(self):#управління лівого гравця
        ...
        if key_pressed[K_s] and self.rect.y < H - self.height:
            self.rect.y += self.speed_y
    ...
    def update_r(self):#управління правого гравця
        ...
        if key_pressed[K_UP] and self.rect.y > 0:
            self.rect.y -= self.speed_y
        if key_pressed[K_DOWN] and self.rect.y < H - self.height:
            self.rect.y += self.speed_y
...
class Ball(GameSprite):
    def move(self):
        ...
        self.rect.y -= self.speed_y
player1 = Player("der.png", 5, 5, 40, 200, 10, 10)
player2 = Player("poli.png", 750, 300, 40, 200, 10, 10)
ball = Ball("DEBIL.png", W / 2, H / 2, 70, 70, 3, 3)
